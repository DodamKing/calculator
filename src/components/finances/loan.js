            ...
            <div style={styles.infoSection}>
                <div style={styles.infoItem}>
                    ...
                    <div style={styles.infoContent}>
                        {`• 대출 금액, 이자율, 기간을 정확히 입력하세요.

                            • 결과는 예상치이며 실제 대출 조건에 따라 다를 수 있습니다.

                            • 추가 상환 옵션을 고려하면 총 이자를 줄일 수 있습니다.

                            • 다양한 시나리오를 비교해보면 최적의 대출 계획을 세울 수 있습니다.

                            • 금융 전문가와 상담하여 개인 상황에 맞는 조언을 받는 것도 좋습니다.`
                        }
                    </div>
                </div>
            </div>
